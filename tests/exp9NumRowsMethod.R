...
source('SNN.R')
source('tests/exp9NumRowsMethodSource.R')
...
df <- runExperiment9(regDs, nRuns = 10)
save(df, file = "tests/Exp9/Exp9RegSmall.Rdata")
#load("tests/Exp9/Exp9RegSmall.Rdata")
...
df <- runExperiment9(hc, nRuns = 10, classification = TRUE)
save(df, file = "tests/Exp9/Exp9BinClassSmall.Rdata")
#load("tests/Exp9/Exp9BinClassSmall.Rdata")
ggplot(data = df$shortResult, aes(x = nrow.method, y = accMean, group = dataset, color = dataset)) +
...
df <- runExperiment9(hc, nRuns = 10, classification = TRUE)
save(df, file = "tests/Exp9/Exp9MultiClassSmall.Rdata")
#load("tests/Exp9/Exp9MultiClassSmall.Rdata")
