...
horse.colic.tr <- read.table ("datasets/HorseColic24/horse_colic.data", sep="", na.strings = "?")
horse.colic.te <- read.table ("datasets/HorseColic24/horse_colic.test", sep="", na.strings = "?")
...
horse.colic <- horse.colic[sample.int(nrow(horse.colic)),]
